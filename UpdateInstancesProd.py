...
def create_asg_based_on_existing(existing_asg_name, new_asg_name):
    ...
    load_balancer_ARN = 'arn:aws:elasticloadbalancing:eu-west-2:925465361057:loadbalancer/app/prod-api-alb/489993a172cda4f5'
    ...
    new_target_group_name = f"new-prod-target-group-{random.randint(0, 10000)}"
...
def get_autoscaling_group():
    ...
    for asg in response['AutoScalingGroups']:
        if 'prod-autoscaling-group' in asg['AutoScalingGroupName']:            
...
if asg_name:
    ...
    new_asg_name = f"prod-autoscaling-group-{random.randint(0, 10000)}"
